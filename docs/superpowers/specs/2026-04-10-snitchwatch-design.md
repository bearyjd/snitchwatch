...
| **M2 — Vendored UI** | Pull `web/`, run rebrand script, serve it from the bridge, point a real browser at it. No Tauri yet — just a browser tab. | Open `http://127.0.0.1:NNNN/` in Firefox, see the LS UI rendered, see live connections from real opensnitchd, click Allow/Deny in the inspector and have it work. |
